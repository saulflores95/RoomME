...
function splitSetCookieString$1(cookiesString) {
  if (Array.isArray(cookiesString)) {
    return cookiesString.flatMap((c) => splitSetCookieString$1(c));
  }
...
function d(o) {
  ...
  for (let n = 0, a = o.length; n < a; n++)
    ((t = Nr(o[n])), t && ((e += o.slice(r, n) + t), (r = n + 1)));
  ...
  : typeof window != "undefined"
    ...
    : typeof self != "undefined"
      ...
      : typeof global != "undefined" &&
        Object.defineProperty(global, O, {
          value: C,
          configurable: true,
          writable: false,
          enumerable: false,
...
function me(o) {
  return o instanceof EvalError
    ...
    : o instanceof RangeError
      ? 2
      : o instanceof ReferenceError
        ? 3
        : o instanceof SyntaxError
          ? 4
          : o instanceof TypeError
            ? 5
            : o instanceof URIError
              ? 6
              : 0;
}
function wr(o) {
...
function j(o, e) {
  ...
  for (let n = 0, a = t.length, i; n < a; n++)
    ((i = t[n]),
      i !== "name" &&
        i !== "message" &&
        (i === "stack"
...
function Er(o, e) {
  return e instanceof Error
    ? `Seroval caught an error during the ${o} process.
...
function Pr(o) {
  return z$1(
    o,
    ["r"],
    "(r.p=new Promise(" + S(o, ["s", "f"], "r.s=s,r.f=f") + "))",
  );
}
function Rr(o) {
...
function Cr(o) {
  return z$1(
    ...
    ["b", "a", "s", "l", "p", "f", "e", "n"],
    "(b=[],a=!0,s=!1,l=[],p=0,f=" +
      S(o, ["v", "m", "x"], "for(x=0;x<p;x++)l[x]&&l[x][m](v)") +
      ",n=" +
      S(
        o,
        ["o", "x", "z", "c"],
      ...
      z$1(
        o,
        ["o", "t"],
        "(a&&(l[t=p++]=o),n(o)," + S(o, [], "a&&(l[t]=void 0)") + ")",
      ) +
      ",{__SEROVAL_STREAM__:!0,on:" +
      z$1(o, ["o"], "e(o)") +
      ",next:" +
      S(o, ["v"], 'a&&(b.push(v),f(v,"next"))') +
      ",throw:" +
      S(o, ["v"], 'a&&(b.push(v),f(v,"throw"),a=s=!1,l.length=0)') +
      ",return:" +
      S(o, ["v"], 'a&&(b.push(v),f(v,"return"),a=!1,s=!0,l.length=0)') +
      "})",
  );
}
function cr(o, e) {
...
function ur(o) {
  return () => {
    let e = [],
      ...
      a = false;
    function i() {
      for (let c = 0, p2 = r.length; c < p2; c++)
        r[c].resolve({ done: true, value: void 0 });
    }
    o.on({
      next(c) {
        let p2 = r.shift();
      ...
      return(c) {
        let p2 = r.shift();
        (p2 && p2.resolve({ done: true, value: c }),
          i(),
          (n = e.length),
          e.push(c));
      },
...
var Y = class {
  constructor(e) {
    ...
    ((this.plugins = e.plugins),
      ...
      (this.refs = e.refs || /* @__PURE__ */ new Map()));
  }
  markRef(e) {
    this.marked.add(e);
  }
  ...
  getIndexedValue(e) {
    ...
    return r != null
      ? (this.markRef(r), { type: 1, value: sr(r) })
  ...
  parseSpecialReference(e) {
    ...
    return r.type === 1
      ? r.value
      : u$1(26, r.value, e, s, s, s, s, s, s, s, s, s);
  }
...
var k = class extends Y {
  async parseItems(e) {
    ...
    for (let t = 0, n = e.length; t < n; t++)
      t in e && (r[t] = await this.parse(e[t]));
    return r;
  }
  ...
  async parseProperties(e) {
    ...
    for (let i = 0, l = r.length; i < l; i++)
      (t.push(d(r[i][0])), n.push(await this.parse(r[i][1])));
    let a = Symbol.iterator;
    return (
      a in e &&
        (t.push(this.parseWellKnownSymbol(a)),
        n.push(M(this.parseIteratorFactory(), await this.parse(J(e))))),
      (a = Symbol.asyncIterator),
      a in e &&
        (t.push(this.parseWellKnownSymbol(a)),
        n.push(U(this.parseAsyncIteratorFactory(), await this.parse(Ve(e))))),
      (a = Symbol.toStringTag),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(w(e[a]))),
      (a = Symbol.isConcatSpreadable),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(e[a] ? I : A)),
      { k: t, v: n, s: t.length }
    );
  }
  ...
  async parseMap(e, r) {
    ...
    for (let [a, i] of r.entries())
      (t.push(await this.parse(a)), n.push(await this.parse(i)));
  ...
  async parsePlugin(e, r) {
    ...
    if (t)
      for (let n = 0, a = t.length; n < a; n++) {
        let i = t[n];
        if (i.parse.async && i.test(r))
          return _(e, i.tag, await i.parse.async(r, this, { id: e }));
      }
    return s;
  }
  ...
  async parseObject(e, r) {
    ...
    if (
      ...
      (t === AggregateError || r instanceof AggregateError)
    )
    ...
    if (Symbol.iterator in r || Symbol.asyncIterator in r)
      return this.parsePlainObject(e, r, !!t);
    throw new g(r);
  }
...
var F = class {
  ...
  deserializeArray(e) {
    let r = e.l,
      t = this.assignIndexedValue(e.i, new Array(r)),
      n;
    for (let a = 0; a < r; a++)
      ((n = e.a[a]), n && (t[a] = this.deserialize(n)));
    return (mr(t, e.o), t);
  }
  deserializeProperties(e, r) {
    ...
    if (t) {
      ...
      for (let i = 0, l; i < t; i++)
        ((l = n[i]),
          typeof l == "string"
            ? (r[N(l)] = this.deserialize(a[i]))
            : (r[this.deserialize(l)] = this.deserialize(a[i])));
    }
    return r;
  }
  deserializeObject(e) {
    let r = this.assignIndexedValue(
      e.i,
      e.t === 10 ? {} : /* @__PURE__ */ Object.create(null),
    );
  ...
  deserializeSet(e) {
    let r = this.assignIndexedValue(e.i, /* @__PURE__ */ new Set()),
      t = e.a;
    for (let n = 0, a = e.l; n < a; n++) r.add(this.deserialize(t[n]));
    return r;
  }
  deserializeMap(e) {
    let r = this.assignIndexedValue(e.i, /* @__PURE__ */ new Map()),
      t = e.e.k,
      n = e.e.v;
    for (let a = 0, i = e.e.s; a < i; a++)
      r.set(this.deserialize(t[a]), this.deserialize(n[a]));
    return r;
  }
  ...
  deserializeError(e) {
    let r = Ze[e.s],
      t = this.assignIndexedValue(e.i, new r(N(e.m)));
    return this.deserializeDictionary(e, t);
  }
  deserializePromise(e) {
    let r = re$1(),
      t = this.assignIndexedValue(e.i, r),
      n = this.deserialize(e.f);
  ...
  deserializePromiseConstructor(e) {
    return this.assignIndexedValue(
      e.i,
      this.assignIndexedValue(e.s, re$1()).promise,
    );
  }
  ...
  deserializeStreamConstructor(e) {
    let r = this.assignIndexedValue(e.i, K()),
      t = e.a.length;
...
function Fr(o) {
  let e = [],
    r = o[0];
  for (let t = 1, n = o.length, a, i = r; t < n; t++)
    ((a = o[t]),
      a.t === 0 && a.v === i.v
        ? (r = { t: 0, s: a.s, k: s, v: se(r) })
        : a.t === 2 && a.s === i.s
          ? (r = { t: 2, s: se(r), k: a.k, v: a.v })
          : a.t === 1 && a.s === i.s
            ? (r = { t: 1, s: se(r), k: s, v: a.v })
            : a.t === 3 && a.s === i.s
              ? (r = { t: 3, s: se(r), k: a.k, v: s })
              : (e.push(r), (r = a)),
      (i = a));
  return (e.push(r), e);
}
...
var Vr = "Object.create(null)",
  ...
  V = class {
    ...
    pushObjectFlag(e, r) {
      e !== 0 &&
        (this.markRef(r),
        this.flags.push({ type: e, value: this.getRefParam(r) }));
    }
    resolveFlags() {
      let e = "";
    ...
    serializeArrayItem(e, r, t) {
      return r
        ? this.isIndexedValueInStack(r)
          ? (this.markRef(e),
            this.createArrayAssign(e, t, this.getRefParam(r.i)),
            "")
          : this.serialize(r)
        : "";
    }
    serializeArray(e) {
      ...
      if (e.l) {
        this.stack.push(r);
        let t = e.a,
          n = this.serializeArrayItem(r, t[0], 0),
          a = n === "";
        for (let i = 1, l = e.l, c; i < l; i++)
          ((c = this.serializeArrayItem(r, t[i], i)),
            (n += "," + c),
            (a = c === ""));
        return (
          this.stack.pop(),
          this.pushObjectFlag(e.o, e.i),
          this.assignIndexedValue(r, "[" + n + (a ? ",]" : "]"))
        );
      }
    ...
    serializeProperty(e, r, t) {
      if (typeof r == "string") {
        let n = Number(r),
          a = (n >= 0 && n.toString() === r) || Le(r);
        if (this.isIndexedValueInStack(t)) {
          let i = this.getRefParam(t.i);
          return (
            this.markRef(e.i),
            a && n !== n
              ? this.createObjectAssign(e.i, r, i)
              : this.createArrayAssign(e.i, a ? r : '"' + r + '"', i),
            ""
          );
        }
    ...
    serializeProperties(e, r) {
      ...
      if (t) {
        ...
        for (let l = 1, c = i; l < t; l++)
          ((c = this.serializeProperty(e, n[l], a[l])),
            (i += (c && i && ",") + c));
    ...
    serializeStringKeyAssignment(e, r, t, n) {
      let a = this.serialize(n),
        i = Number(t),
        l = (i >= 0 && i.toString() === t) || Le(t);
      if (this.isIndexedValueInStack(n))
        l && i !== i
          ? this.createObjectAssign(e.i, t, a)
          : this.createArrayAssign(e.i, l ? t : '"' + t + '"', a);
      else {
    ...
    serializeAssignment(e, r, t, n) {
      if (typeof t == "string") this.serializeStringKeyAssignment(e, r, t, n);
        ...
        ((this.assignments = r),
          this.createArrayAssign(e.i, this.serialize(t), i),
          (this.assignments = l));
      }
    }
    ...
    serializeDictionary(e, r) {
      if (e.p)
        if (this.features & 8) r = this.serializeWithObjectAssign(e, e.p, r);
        else {
          this.markRef(e.i);
    ...
    serializeSetItem(e, r) {
      return this.isIndexedValueInStack(r)
        ? (this.markRef(e),
          this.createAddAssignment(e, this.getRefParam(r.i)),
          "")
        : this.serialize(r);
    }
    serializeSet(e) {
      ...
      if (t) {
        ...
        for (let l = 1, c = i; l < t; l++)
          ((c = this.serializeSetItem(n, a[l])), (i += (c && i && ",") + c));
    ...
    serializeMapEntry(e, r, t, n) {
      if (this.isIndexedValueInStack(r)) {
        ...
        if (t.t !== 4 && t.i != null && this.isMarked(t.i)) {
          ...
          return (
            this.createSetAssignment(e, a, this.getRefParam(t.i)),
            this.createDeleteAssignment(e, n),
            l
          );
        }
        let i = this.stack;
        return (
          (this.stack = []),
          this.createSetAssignment(e, a, this.serialize(t)),
          (this.stack = i),
          ""
        );
      }
      if (this.isIndexedValueInStack(t)) {
        ...
        if ((this.markRef(e), r.t !== 4 && r.i != null && this.isMarked(r.i))) {
          ...
          return (
            this.createSetAssignment(e, this.getRefParam(r.i), a),
            this.createDeleteAssignment(e, n),
            l
          );
        }
        ...
        return (
          (this.stack = []),
          this.createSetAssignment(e, this.serialize(r), a),
          (this.stack = i),
          ""
        );
      }
    ...
    serializeMap(e) {
      let r = Br,
        ...
        n = e.i,
        a = e.f,
        i = this.getRefParam(a.i);
      if (t) {
        let l = e.e.k,
          c = e.e.v;
        this.stack.push(n);
        let p2 = this.serializeMapEntry(n, l[0], c[0], i);
        for (let h = 1, X = p2; h < t; h++)
          ((X = this.serializeMapEntry(n, l[h], c[h], i)),
            (p2 += (X && p2 && ",") + X));
        (this.stack.pop(), p2 && (r += "([" + p2 + "])"));
      }
      return (
        a.t === 26 &&
          (this.markRef(a.i), (r = "(" + this.serialize(a) + "," + r + ")")),
        this.assignIndexedValue(n, r)
      );
    }
    ...
    serializeAggregateError(e) {
      let r = e.i;
      this.stack.push(r);
      let t = this.serializeDictionary(
        e,
        'new AggregateError([],"' + e.m + '")',
      );
    ...
    serializeIteratorFactory(e) {
      ...
      return (
        e.f.t !== 4 &&
          (this.markRef(e.f.i),
          (r = "(" + this.serialize(e.f) + ","),
          (t = true)),
        (r += this.assignIndexedValue(
          e.i,
          this.createFunction(
            ["s"],
            this.createFunction(
    ...
    serializeAsyncIteratorFactory(e) {
      let r = e.a[0],
        t = e.a[1],
        n = "";
      (r.t !== 4 && (this.markRef(r.i), (n += "(" + this.serialize(r))),
        t.t !== 4 &&
          (this.markRef(t.i), (n += (n ? "," : "(") + this.serialize(t))),
        n && (n += ","));
      let a = this.assignIndexedValue(
        e.i,
        this.createFunction(
          ["s"],
          this.createFunction(
    ...
    serializeStreamConstructor(e) {
      let r = this.assignIndexedValue(e.i, this.getConstructor(e.f) + "()"),
        t = e.a.length;
      if (t) {
...
var D = class extends V {
  ...
  serializeTop(r) {
    let t = this.serialize(r),
      n = r.i;
    if (n == null) return t;
    let a = this.resolvePatches(),
      i = this.getRefParam(n),
      l = this.scopeId == null ? "" : Q,
      c = a ? "(" + t + "," + a + i + ")" : t;
    if (l === "") return r.t === 10 && !a ? "(" + c + ")" : c;
    let p2 =
      this.scopeId == null ? "()" : "(" + Q + '["' + d(this.scopeId) + '"])';
...
var v = class extends Y {
  ...
  parseProperties(e) {
    let r = Object.entries(e),
      ...
      n = [];
    for (let i = 0, l = r.length; i < l; i++)
      (t.push(d(r[i][0])), n.push(this.parse(r[i][1])));
    let a = Symbol.iterator;
    return (
      a in e &&
        (t.push(this.parseWellKnownSymbol(a)),
        n.push(M(this.parseIteratorFactory(), this.parse(J(e))))),
      (a = Symbol.asyncIterator),
      a in e &&
        (t.push(this.parseWellKnownSymbol(a)),
        n.push(U(this.parseAsyncIteratorFactory(), this.parse(K())))),
      (a = Symbol.toStringTag),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(w(e[a]))),
      (a = Symbol.isConcatSpreadable),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(e[a] ? I : A)),
  ...
  parseMap(e, r) {
    let t = [],
      n = [];
    for (let [a, i] of r.entries())
      (t.push(this.parse(a)), n.push(this.parse(i)));
    return this.createMapNode(e, t, n, r.size);
  }
  parseSet(e, r) {
    let t = [];
  ...
  parsePlugin(e, r) {
    ...
    if (t)
      for (let n = 0, a = t.length; n < a; n++) {
        let i = t[n];
        if (i.parse.sync && i.test(r))
          return _(e, i.tag, i.parse.sync(r, this, { id: e }));
      }
  }
  parseStream(e, r) {
...
var oe = class extends v {
  constructor(r) {
    ...
    this.initial = true;
    this.buffer = [];
    ((this.onParseCallback = r.onParse),
      (this.onErrorCallback = r.onError),
      (this.onDoneCallback = r.onDone));
  }
  onParseInternal(r, t) {
    try {
  ...
  parseProperties(r) {
    ...
    for (let l = 0, c = t.length; l < c; l++)
      (n.push(d(t[l][0])), a.push(this.parse(t[l][1])));
    let i = Symbol.iterator;
    return (
      i in r &&
        (n.push(this.parseWellKnownSymbol(i)),
        a.push(M(this.parseIteratorFactory(), this.parse(J(r))))),
      (i = Symbol.asyncIterator),
      i in r &&
        (n.push(this.parseWellKnownSymbol(i)),
        a.push(U(this.parseAsyncIteratorFactory(), this.parse(Ve(r))))),
      (i = Symbol.toStringTag),
      i in r && (n.push(this.parseWellKnownSymbol(i)), a.push(w(r[i]))),
      (i = Symbol.isConcatSpreadable),
      i in r && (n.push(this.parseWellKnownSymbol(i)), a.push(r[i] ? I : A)),
      { k: n, v: a, s: n.length }
    );
  }
    ...
    (n &&
      this.onParse(
        u$1(
          ...
          s,
          s,
          [this.parseSpecialReference(2), n],
          s,
          s,
          s,
        ),
      ...
      n &&
        this.onParse(
          u$1(
            ...
            s,
            s,
            [this.parseSpecialReference(3), n],
            s,
            s,
            s,
          ),
  ...
  parsePromise(r, t) {
    ...
    return (
      t.then(
        this.handlePromiseSuccess.bind(this, n),
        this.handlePromiseFailure.bind(this, n),
      ),
      this.pushPendingState(),
      this.createPromiseConstructorNode(r, n)
    );
  }
  parsePlugin(r, t) {
    let n = this.plugins;
    if (n)
      for (let a = 0, i = n.length; a < i; a++) {
        let l = n[a];
        if (l.parse.stream && l.test(t))
          return _(r, l.tag, l.parse.stream(t, this, { id: r }));
      }
    return s;
  }
  parseStream(r, t) {
...
var p = {},
  ee2 = Hr({
    ...
    serialize(e, r) {
      return r.createFunction(
        ["d"],
        "new ReadableStream({start:" +
          r.createEffectfulFunction(
            ["c"],
            "d.on({next:" +
              r.createEffectfulFunction(["v"], "try{c.enqueue(v)}catch{}") +
              ",throw:" +
              r.createEffectfulFunction(["v"], "c.error(v)") +
              ",return:" +
              r.createEffectfulFunction([], "try{c.close()}catch{}") +
              "})",
          ) +
          "})",
      );
...
const minifiedTsrBootStrapScript =
  'self.$_TSR={c(){document.querySelectorAll(".\\\\$tsr").forEach(e=>{e.remove()})},p(e){this.initialized?e():this.buffer.push(e)},buffer:[]};\n';
const SCOPE_ID = "tsr";
...
function attachRouterServerSsrUtils({ router, manifest: manifest2 }) {
  ...
  router.serverSsr = {
    ...
    dehydrate: async () => {
      ...
      const plugins =
        router.options.serializationAdapters?.map((t) =>
          makeSsrSerovalPlugin(t, trackPlugins),
        ) ?? [];
      gr(dehydratedRouter, {
      ...
      const headerEntries =
        ...
        (initHeaders
          ? Array.isArray(initHeaders)
            ...
            : initHeaders?.entries
              ? initHeaders.entries()
              : Object.entries(initHeaders).map(([k2, v2]) => [
                  k2.toLowerCase(),
                  v2,
                ])
          : void 0);
      ...
      nullBody(event.req.method, status) ? null : res.body,
      {
        ...
        headers:
          res.headers && eventHeaders
            ? mergeHeaders$1(res.headers, eventHeaders)
            : res.headers || eventHeaders,
      },
    );
  }
...
async function getStartManifest() {
  const { tsrStartManifest } = await import(
    "./_tanstack-start-manifest_v-BwWKDVYu.mjs"
  );
...
let regex = void 0;
const handleServerAction = async ({ request, context }) => {
  ...
  if (typeof serverFnId !== "string") {
    throw new Error(
      "Invalid server action param for serverFnId: " + serverFnId,
    );
  }
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-DT_aQl4p.mjs").then((n) => n.r);
    }
    if (startEntry === null) {
      ...
      if (
        ...
        throw new Error(
          `Server side redirects must use static search, params, and hash values and do not support functional values. Received functional values for: ${Object.keys(
            ...
            .filter((d2) => typeof response.options[d2] === "function")
            .map((d2) => `"${d2}"`)
            .join(", ")}`,
        );
      }
...
async function handleServerRoutes({
  ...
  middlewares.push(
    handlerToMiddleware((ctx2) =>
      executeRouter({ serverContext: ctx2.context }),
    ),
  );
...
export { serverEntry as default, getRequestHeaders as g };
